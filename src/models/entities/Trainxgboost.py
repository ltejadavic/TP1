...
class Trainxgboost(db.Model):
    __tablename__ = 'Trainxgboost'
    ...
    # Relaciones
    usuario = db.relationship('User', backref=db.backref('trainxgboosts', lazy=True))
    dataset = db.relationship('Dataset', backref=db.backref('trainxgboosts', lazy=True))
